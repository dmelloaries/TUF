...
const FlashCard = ({ question, answer }) => {
  ...
  return (
    ...
    >
      ...
      >
        {/* Front Side */}
        <div className="absolute w-full h-full bg-[#222] text-white flex items-center justify-center backface-hidden rounded-xl shadow-lg border border-transparent hover:border-[#de4227] hover:text-[#de4227]">
